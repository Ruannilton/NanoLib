...
#define stl_declare_array(type)                                                                           \
    ...
    stl_declare(type);                                                                                    \
                                                                                                          \
    void __stl_fn(type, array, create)(array(type) * arr);                                                \
    ...
    bool __stl_fn(type, array, find)(array(type) * arr, type value);                                      \
    bool __stl_fn(type, array, find_cmp)(array(type) * arr, type value, bool (*cmp)(type a, type b));     \
...
#define stl_implement_array(type)                                                                        \
    ...
    void __stl_fn(type, array, create)(array(type) * arr)                                                \
    {                                                                                                    \
        arr->lenght = ARRAY_INITIAL_LEN;                                                                 \
        __stl_fn(type, __base_name, create)(&(arr->buffer), ARRAY_INITIAL_LEN);                          \
    }                                                                                                    \
    void __stl_fn(type, array, desloc)(array(type) * arr, size_t from, int steps)                        \
    {                                                                                                    \
