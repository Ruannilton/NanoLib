/*! \file stl_core.h
 * \brief This file contais the core functions to others algorithms.
 *  
 * The most common data structures utilize the same algorithms to do their operations
 * for less duplication code purpose, this algorithms are implemented once in this file
 * and the others data structures call him internally
 * */
