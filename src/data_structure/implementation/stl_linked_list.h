...
#define stl_implement_linked_list(type)                                                                                                                                  \
    ...
    {                                                                                                                                                                    \
        ...
        for (size_t i = 0; i < arr->count; i++)                                                                                                                          \
        {                                                                                                                                                                \
            __stl_fn(type, linked_list, add)(*out, map(current->value, i));                                                                                              \
            current = current->pnext;                                                                                                                                    \
        }                                                                                                                                                                \
    }                                                                                                                                                                    \
    ...
    {                                                                                                                                                                    \
        ...
        {                                                                                                                                                                \
            ...
            if (_a > 0)                                                                                                                                                  \
                __stl_fn(type, linked_list, add)(*out, _v);                                                                                                              \
            current = current->pnext;                                                                                                                                    \
        }                                                                                                                                                                \
    }                                                                                                                                                                    \
    type __stl_fn(type, linked_list, last)(__stl_t(type, linked_list) * arr) { return __stl_fn(type, linked_list, get)(arr, arr->count - 1); }
